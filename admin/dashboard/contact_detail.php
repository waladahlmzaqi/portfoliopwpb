...
require '../../koneksi.php';
$id = $_GET['id'];
$tb_contact = query("SELECT * FROM tb_pesan WHERE id = $id")[0];
?>
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <div class="section-header">
            ...
            <!--  ======================= Detail Pesan ================================ -->
                <div class="container">
                    <div class="card">
                    <div class="card-body">
                        <h6 class="card-title"><i class="fas fa-bars me-2 mt-2"></i>Data Pesan</h6>
                        <a href="dashboard.php" style="float: right; margin-top: -35px;" type="button" class="btn btn-primary">Kembali</a>
                    </div>
