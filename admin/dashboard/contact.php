<?php
require '../../koneksi.php';
$tb_contact  = query("SELECT * FROM tb_pesan ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered table-md table-hover">
                    ...
                    <tbody>
                      <?php foreach ($tb_contact as $key => $tb_contact) { ?>
                      <tr>
                        <td><?= $key + 1 ?></td>
                          <td><?= $tb_contact['nama'] ?></td>
                          <td><?= $tb_contact['email'] ?></td>
                          <td><?= $tb_contact['pesan'] ?></td>
                          <td class="text-center">
                              <a href="contact_detail.php?id=<?= $tb_contact['id'] ?>" class=" btn-sm btn btn-primary btn-circle">
                                  <i class="fa fa-search" aria-hidden="true"></i>
                              </a>
                              <a href="hapus.php?id=<?= $tb_contact['id']; ?>" class="btn-sm btn btn-danger btn-circle" 
