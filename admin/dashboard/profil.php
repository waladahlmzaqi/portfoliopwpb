                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="card-body text-center">
                                    <p hidden><?= 1 ?></p>
                                    <img src="<?= $tb_datadiri['img'] ?>" class="card-img-top" style="max-width: min-content;">
                                </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center mb-3">
                                        ...
                                        <div class="col-7">
                                        <label class="col-form-label"><h6 class="fw-light"><?= $tb_datadiri['nama'] ?></h6></label>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-items-center mb-3" style="margin-top: -45px;">
                                        <div class="col-4">
                                        <label class="col-form-label"><h6>Kelas : </h6></label>
                                        </div>
                                        <div class="col-7">
                                        <label class="col-form-label"><h6 class="fw-light"><?= $tb_datadiri['kelas'] ?></h6></label>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-items-center mb-3" style="margin-top: -45px;">
                                        <div class="col-4">
                                        <label class="col-form-label"><h6>Jurusan : </h6></label>
                                        </div>
                                        <div class="col-7">
                                        <label class="col-form-label"><h6 class="fw-light"><?= $tb_datadiri['jurusan'] ?></h6></label>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-items-center mb-3" style="margin-top: -45px;">
                                        <div class="col-4">
                                        <label class="col-form-label"><h6>Sekolah : </h6></label>
                                        </div>
                                        <div class="col-7">
